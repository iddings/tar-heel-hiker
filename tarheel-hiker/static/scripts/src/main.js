require(['require', '/asset/scripts/config-dev.js'], function (require, config) {
    ...
    requirejs(
        ...
        function(angular){
            ...
            angular.module('hiker', ['ngMaterial', 'ngMdIcons', 'ui.router', 'hiker.hike', 'hiker.home'])
                .config(function($locationProvider, $stateProvider, $urlMatcherFactoryProvider){
                    ...
                    $stateProvider
                        .state('home', {
                            url: '/',
                            template: '<hike-home></hike-home>'
                        })
                        .state('hike', {
                            url: '/hike',
                            template: '<hike-page></hike-page>',
                            abstract: true
                        })
                        .state('hike.overview', {
                            url: '/:hike'
